...
variable "inbound_cidr_block" {
  description = "Please provide a more restrictive CIDR block for inbound traffic (e.g., your public IP address with a /32 suffix, like '192.0.2.1/32'), instead of '0.0.0.0/0'."
  type        = string
}
